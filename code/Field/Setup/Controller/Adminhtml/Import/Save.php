 ...
 */
namespace Field\Setup\Controller\Adminhtml\Import;
...
class Save extends \Magento\Backend\App\Action
{
    ...
    /**
     * @var \Field\Setup\Helper\Import
     */
    protected $_fieldImport;
     ...
     * @param \Field\Setup\Helper\Import                                     $fieldImport           
    ...
    public function __construct(
        ...
        \Field\Setup\Helper\Import $fieldImport,
                ...
                foreach ($importData as $_module) {
                    if(isset($_module['tables'])){
                        ...
                        foreach ($tables as $tablename => $rows) {
                            ...
                            foreach ($rows as $row) {
                                $where = '';
                                $query_data = $this->_fieldImport->buildQueryImport($row, $table_name, $overwrite, $data['store_id']); 
