 ...
 */
namespace Field\Setup\Block\Adminhtml\Import\Edit;
...
class Form extends \Magento\Backend\Block\Widget\Form\Generic
{
    ...
    /**
     * @var \Field\Setup\Model\System\Config\Source\Import
     */
     ...
     * @param \Field\Setup\Model\System\Config\Source\Import\Files         $importFiles   
     * @param Yesno                                                      $yesNo         
     * @param array                                                      $data          
     */
    public function __construct(
        ...
        \Field\Setup\Model\System\Config\Source\Import\Files $importFiles,
    ...
    protected function _prepareForm()
    {
         ...
         */
        if($this->_isAllowedAction('Field_Setup::import')){
        ...
        $fieldset = $form->addFieldset('base_fieldset', ['legend' => __('Field Setup Import')]);
            ...
            $fieldPreset = $fieldset->addField($key,
                'select', [
                    ...
                    require(["jquery"], function(){
                        ...
                        jQuery(".field-import").change(function(){
