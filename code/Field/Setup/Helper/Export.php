...
class Export extends \Magento\Framework\App\Helper\AbstractHelper
{
	...
	public function getModuleTables() {
		$sql_tables = [
		"Field_Blog" => ["field_blog_category", "field_blog_category_store","field_blog_post", "field_blog_post_category", "field_blog_post_tag", "field_blog_post_related", "field_blog_post_store", "field_blog_comment", "field_blog_comment_store"],
		"Field_Testimonial" => ["field_testimonial_testimonial","field_testimonial_testimonial_store"],
		"Field_PageBuilder" => ["field_blockbuilder_block", "field_blockbuilder_cms","field_blockbuilder_page"],
		"Field_Brand" => ["field_brand_group", "field_brand","field_brand_store"],
		"Field_Megamenu" => ["field_megamenu_menu", "field_megamenu_menu_store","field_megamenu_item"],
