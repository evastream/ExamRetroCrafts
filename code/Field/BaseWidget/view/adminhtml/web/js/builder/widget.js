...
var FieldCallBack = {};
var FieldCurrentCol = null;
var FieldCurrentWidget = null;
var FieldCurrentShortcode = "";
...
define([
    ...
    "Field_BaseWidget/js/jquery/ui/jquery-ui.min",
    "mage/translate",
    "mage/mage",
    "mage/validation",
    ...
    var WysiwygWidgetTools = {
        ...
        openDialog: function(widgetUrl, objbuilder, callback, col ) {
            ...
            FieldBuilder = new Field_Builder();
            FieldBuilder.currentShortcode = "";
            FieldBuilder.currentWidget = null;
            FieldBuilder.builder = objbuilder;
            FieldBuilder.callback['widget'] = callback;
            FieldBuilder.currentCol = col;
        ...
        openFormDialog: function(widgetUrl, widget, widget_shortcode, objbuilder, callback, col ) {
            ...
            FieldBuilder = new Field_Builder();
            FieldBuilder.currentShortcode = widget_shortcode;
            FieldBuilder.currentWidget = widget;
            FieldBuilder.builder = objbuilder;
            FieldBuilder.callback['widget'] = callback;
            FieldBuilder.currentCol = col;
    ...
    WysiwygWidget.Widget.prototype = {
        ...
        initOptionValue: function(widgetCode) {
            var widgetCode = FieldBuilder.currentShortcode!=null?FieldBuilder.currentShortcode:"";
            if (widgetCode.indexOf('{{widget') != -1) {
                    this.optionValues = new Hash({});
                    widgetCode.gsub(/([a-z0-9\_]+)\s*\=\s*[\"]{1}([^\"]+)[\"]{1}/i, function(match){
                        if (match[1] == 'type') {
        ...
        updateContent: function(content) {
            if(typeof(FieldBuilder.callback['widget']) != "undefined" && typeof FieldBuilder.callback['widget'] == "function") {
               FieldBuilder.callback['widget'].call( FieldBuilder.builder, FieldBuilder.currentCol, FieldBuilder.currentWidget, content  );
