...
{ 
  ...
  /**
     ...
     * @param \Field\BaseWidget\Helper\Widget                          $widgetHelper   
    ...
    protected function getBlock()
    {
        if($this->_model) {
          ...
          $this->_model = $this->_coreRegistry->registry('field_pagebuilder');
          return $this->_model;
        }
