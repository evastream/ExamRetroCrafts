 ...
 */
namespace Field\PageBuilder\Model;
...
{	
     ...
     * Block cache tag
     */
    const CACHE_BLOCK_TAG = 'field_pagebuilder_block';

    /**
     * Page cache tag
     */
    const CACHE_TAG = 'field_pagebuilder_page';
     ...
     * @param \Field\PageBuilder\Model\ResourceModel\Block|null                      $resource                 
     * @param \Field\PageBuilder\Model\ResourceModel\Block\Collection|null           $resourceCollection       
    ...
    public function __construct(
        ...
        \Field\PageBuilder\Model\ResourceModel\Block $resource = null,
        \Field\PageBuilder\Model\ResourceModel\Block\Collection $resourceCollection = null,
    ...
    {
        $this->_init('Field\PageBuilder\Model\ResourceModel\Block');
    }
