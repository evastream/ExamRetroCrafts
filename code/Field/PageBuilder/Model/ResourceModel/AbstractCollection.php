    ...
    protected function performAfterLoad($tableName, $columnName)
    {
        ...
        foreach ($this as $item) {
            ...
            if($item->getData('block_id')) {
              ...
              $page_stores = $this->_objectManager->create('Field\PageBuilder\Model\ResourceModel\Block')->lookupStoreIds($item->getData('block_id'));

            }

            if($alias = $item->getData("alias")) {
              $cms_page = $this->_objectManager->create('Field\PageBuilder\Model\Block')->loadCMSPage($alias, "identifier", $page_stores);
