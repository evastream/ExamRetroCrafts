...
class Livecss extends \Magento\Framework\View\Element\Template
{
    ...
    public function _toHtml() {
        if(!$this->_dataHelper->getConfig('general/show', null, 0, 'fieldlivecss')) return;
    ...
    public function getLiveEditLink() {
        return $this->actionUrlBuilder->getDirectUrl( "fieldpagebuilder/livecss/generate" );
    }
    /**
     *
     */
    public function renderEditorThemeForm( $profile_name = ""){
        if(!$profile_name) {
            $profile_name = $this->getBlockHelper()->getConfig("general/live_profile", null, "default", "fieldlivecss");
        }
    ...
    public function isAllowCurrentIp() {
        $allowedIPsString = $this->getBlockHelper()->getConfig("general/allowedIPs", null, "", "fieldlivecss");
        ...
        $allowFrontendForAdmins = $this->getBlockHelper()->getConfig("general/allowFrontendForAdmins", null, "1", "fieldlivecss");
