 ...
 */
namespace Field\PageBuilder\Block\Adminhtml\Blockbuilder;
...
class Edit extends \Magento\Backend\Block\Widget\Form\Container
{
    ...
    protected function _construct(){
    	...
    	$this->_blockGroup = 'Field_PageBuilder';
    	$this->_controller = 'adminhtml_blockbuilder';

    	parent::_construct();

    	if($this->_isAllowedAction('Field_PageBuilder::block_save')){
            ...
            if($this->_coreRegistry->registry('field_pagebuilder')->getId()) {
                $this->buttonList->add(
                    'duplicate',
                    [
                        'label' => __('Duplicate'),
    	...
    	if ($this->_isAllowedAction('Field_PageBuilder::block_delete') && $this->_coreRegistry->registry('field_pagebuilder')->getId()) {
    ...
    {
        if ($this->_coreRegistry->registry('field_pagebuilder')->getId()) {
            return __("Edit Profile '%1'", $this->escapeHtml($this->_coreRegistry->registry('field_pagebuilder')->getTitle()));
        } else {
