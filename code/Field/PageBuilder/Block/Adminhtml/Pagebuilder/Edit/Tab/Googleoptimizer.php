 ...
 */
namespace Field\PageBuilder\Block\Adminhtml\Pagebuilder\Edit\Tab;
...
class Googleoptimizer extends \Magento\Backend\Block\Widget\Form\Generic implements \Magento\Backend\Block\Widget\Tab\TabInterface
{
     ...
     * @param \Field\PageBuilder\Helper\Code $codeHelper
     * @param \Field\PageBuilder\Helper\Data $helperData
    ...
    public function __construct(
        ...
        \Field\PageBuilder\Helper\Code $codeHelper,
        \Field\PageBuilder\Helper\Data $helperData,
    ...
    {
        $entity = $this->_registry->registry('field_pagebuilder');
        if (!$entity) {
    ...
    protected function _prepareForm()
    {
         ...
         */
        if($this->_isAllowedAction('Field_PageBuilder::page_edit')){
