    ...
    \Magento\Backend\Block\Widget\Tab\TabInterface
{
    ...
    protected function _prepareForm()
    {
         ...
         */
        $isElementDisabled = !$this->_isAllowedAction('Field_PageBuilder::block_edit');
        ...
        $layoutFieldset->addType('extended_editor','\Field\PageBuilder\Helper\Form\Element\Extendededitor');
