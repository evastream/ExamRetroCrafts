 ...
 */
namespace Field\PageBuilder\Block\Adminhtml\Pagebuilder;
...
class Edit extends \Magento\Backend\Block\Widget\Form\Container
{
    ...
    protected function _construct(){
    	...
    	if($this->_isAllowedAction('Field_PageBuilder::page_save')){
    	...
    	if ($this->_isAllowedAction('Field_PageBuilder::page_delete')) {
