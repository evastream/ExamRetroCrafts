 ...
 */
namespace Field\PageBuilder\Controller\Livecss;
...
class Generate extends \Magento\Framework\App\Action\Action
{
    ...
    public function isAllowCurrentIp() {
        $allowedIPsString = $this->_dataHelper->getConfig("general/allowedIPs", null, "", "fieldlivecss");
        ...
        $allowFrontendForAdmins = $this->_dataHelper->getConfig("general/allowFrontendForAdmins", null, "1", "fieldlivecss");
    ...
    public function execute()
    {
        ...
        $show = $this->_dataHelper->getConfig('general/show', null, 0, 'fieldlivecss');
        $allow_save_profile = $this->_dataHelper->getConfig("general/allow_save_profile", null, "0", "fieldlivecss");
