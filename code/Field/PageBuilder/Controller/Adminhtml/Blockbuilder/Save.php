...
class Save extends \Magento\Backend\App\Action
{
    ...
    {
    	return $this->_authorization->isAllowed('Field_PageBuilder::block_save');
    }
    ...
    public function execute()
    {
        ...
        if ($post_data) {
            ...
            if ($this->getRequest()->getParam("duplicate")) {
                ...
                $settings = [];
                $block_data['shortcode'] = $this->_viewHelper->getShortCode("Field\PageBuilder\Block\Widget\Builder", $this->getRequest()->getParam("block_id"), $settings);
                ...
                $post_data['shortcode'] = $this->_viewHelper->getShortCode("Field\PageBuilder\Block\Widget\Builder", $this->getRequest()->getParam("block_id"), $settings);
            ...
            try {
                ...
                if($this->_viewHelper->getConfig('general/auto_backup_profile')) {
                    $this->_viewHelper->autoBackupLayoutProfile( $post_data, "fieldblockbuilder" );
                }
