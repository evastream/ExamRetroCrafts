 ...
 */
namespace Field\PageBuilder\Helper;
...
{
    protected static $_list_dragable_blocks = array("Field_",
    ...
    protected static $_list_editable_blocks = array("Field_",
                                                    "Mage_Page_Block_Html_Header",
                                                    "Mage_Page_Block_Html_Breadcrumbs",
                                                    "Mage_Reports_Block_Product_Viewed",
                                                    "Mage_Catalog_Block_Layer_View",
     ...
     * @return string|null
     */
    public function getConfig($key, $store = null, $default = "", $section = "fieldpagebuilder")
    {
    ...
    public function generatePageBuilder($alias = "") {
        if($alias) {
            $short_code = $this->getShortCode("Field\PageBuilder\Block\Widget\Block", $alias);
    ...
    public function autoBackupLayoutProfile($data = array(), $folder = "fieldpagebuilder") {
    ...
    public function getBackupLayouts($folder_name = "fieldpagebuilder") {
        $result = array();
        $file_ext = ".json";
