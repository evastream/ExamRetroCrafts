 ...
 */
namespace Field\Megamenu\Helper;
...
class Editor extends \Magento\Framework\App\Helper\AbstractHelper
{
    ...
    public function __construct(
        ...
        \Field\Megamenu\Model\Config\Source\MenuType $menuType,
        \Field\Megamenu\Model\Config\Source\Yesno $yesno,
        \Field\Megamenu\Model\Config\Source\Status $status,
        \Field\Megamenu\Model\Config\Source\CategoryList $categoryList,
        \Field\Megamenu\Model\Config\Source\LinkTarget $linkTarget,
        \Field\Megamenu\Model\Config\Source\LinkType $linkType,
        \Field\Megamenu\Model\Config\Source\AlignType $alignType,
        \Field\Megamenu\Model\Config\Source\RepeatType $repeatType,
        \Field\Megamenu\Model\Config\Source\IconPosition $iconPosition,
        \Field\Megamenu\Model\Config\Source\ChilCol $childCol,
        ...
        if(isset($field['type'])){
            ...
            switch ($field['type']) {
                ...
                $html .= $this->_layout->createBlock(
                    ...
                    'onclick' => "FieldMediabrowserUtility.openDialog('" . $this->getUrl('cms/wysiwyg_images/index',
                        [
                ...
                $editorId = 'editor'.time().rand();
                $html = '<textarea id="'.$editorId.'" data-key=' . $fieldName . ' class="'.$classes.' field-editor" style="height:400px;"  data-bind="{value: '.$fieldName.', if: status==1}" data-ui-id="product-tabs-attributes-tab-fieldset-element-textarea-'.$editorId.' aria-hidden="true"></textarea>';
                $html .= $this->_layout->createBlock(
                    'Magento\Backend\Block\Widget\Button',
                    '',
                    [
                ...
                $mcPath = $mediaUrl.'field/megamenu';
                $html .= '<script>
                require([
                    "jquery",
                    "Field_Megamenu/js/mcolorpicker/mcolorpicker.min"
                    ], function (jQuery) {
