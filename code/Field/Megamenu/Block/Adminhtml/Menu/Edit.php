 ...
 */
namespace Field\Megamenu\Block\Adminhtml\Menu;
...
class Edit extends \Magento\Backend\Block\Widget\Form\Container
{
    ...
    protected function _construct()
    {
        ...
        $this->_blockGroup = 'Field_Megamenu';
        $this->_controller = 'adminhtml_menu';

        parent::_construct();

        if ($this->_isAllowedAction('Field_Megamenu::menu_save')) {
        ...
        if ($this->_isAllowedAction('Field_Megamenu::menu_delete')) {
