 ...
 */
namespace Field\Megamenu\Block\Adminhtml\Menu\Edit;
...
class Form extends \Magento\Backend\Block\Widget\Form\Generic
{
     ...
     * @var string
     */
    protected $_template = 'Field_Megamenu::widget/form.phtml';
    ...
    /**
     * @var \Field\Megamenu\Model\Config\Source\MobileTempalte
     */
    ...
    protected function _prepareForm()
    {
        ...
        $renderer = $this->getLayout()->createBlock(
            'Field\Megamenu\Block\Adminhtml\Renderer\Fieldset\EditorTop'
            );
        ...
        $renderer = $this->getLayout()->createBlock(
            'Field\Megamenu\Block\Adminhtml\Renderer\Fieldset\Editor'
            );
        $field->setRenderer($renderer);
