...
class Products extends \Magento\Catalog\Block\Product\AbstractProduct implements \Magento\Widget\Block\BlockInterface
{
	 ...
	 * @param \Field\Megamenu\Model\Product            $productModel 
	 * @param array                                  $data         
	 */
	public function __construct(
		\Magento\Catalog\Block\Product\Context $context,
		\Field\Megamenu\Model\Product $productModel,
		array $data = []
		) {
     ...
     */
    public function getFieldProductPriceHtml(
